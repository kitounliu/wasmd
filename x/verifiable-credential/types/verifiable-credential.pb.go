...
type AnonymousCredentialSchemaSubject struct {
	...
	BbsPlusParams *BbsPlusParameters     `protobuf:"bytes,3,opt,name=bbs_plus_params,json=bbsPlusParams,proto3" json:"bbs_plus_params,omitempty"`
...
func (m *AnonymousCredentialSchemaSubject) GetBbsPlusParams() *BbsPlusParameters {
	if m != nil {
...
type BbsPlusParameters struct {
	...
	PublicParams string   `protobuf:"bytes,3,opt,name=public_params,json=publicParams,proto3" json:"public_params,omitempty"`
}

func (m *BbsPlusParameters) Reset()         { *m = BbsPlusParameters{} }
func (m *BbsPlusParameters) String() string { return proto.CompactTextString(m) }
func (*BbsPlusParameters) ProtoMessage()    {}
func (*BbsPlusParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_caa28180a9dfbf42, []int{2}
}
func (m *BbsPlusParameters) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BbsPlusParameters) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BbsPlusParameters.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BbsPlusParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BbsPlusParameters.Merge(m, src)
}
func (m *BbsPlusParameters) XXX_Size() int {
	return m.Size()
}
func (m *BbsPlusParameters) XXX_DiscardUnknown() {
	xxx_messageInfo_BbsPlusParameters.DiscardUnknown(m)
}

var xxx_messageInfo_BbsPlusParameters proto.InternalMessageInfo

func (m *BbsPlusParameters) GetType() []string {
	if m != nil {
		return m.Type
	}
	return nil
...
func (m *BbsPlusParameters) GetContext() []string {
	if m != nil {
		return m.Context
	}
	return nil
...
func (m *BbsPlusParameters) GetPublicParams() string {
	if m != nil {
...
type AccumulatorParameters struct {
	...
	Context      []string `protobuf:"bytes,2,rep,name=context,proto3" json:"context,omitempty"`
	PublicParams string   `protobuf:"bytes,3,opt,name=public_params,json=publicParams,proto3" json:"public_params,omitempty"`
	// state is used together with accumulator for proving membership or non-revocation
...
func (m *AccumulatorParameters) GetContext() []string {
	if m != nil {
		return m.Context
	}
	return nil
...
func (m *AccumulatorParameters) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (*VcMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_caa28180a9dfbf42, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*BbsPlusParameters)(nil), "wasmd.verifiablecredential.BbsPlusParameters")
...
var fileDescriptor_caa28180a9dfbf42 = []byte{
	...
	,
}
...
func (m *AnonymousCredentialSchemaSubject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BbsPlusParams != nil {
		{
			size, err := m.BbsPlusParams.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BbsPlusParameters) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BbsPlusParameters) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BbsPlusParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AccumulatorParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.State) > 0 {
		i -= len(m.State)
		copy(dAtA[i:], m.State)
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.State)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.PublicParams) > 0 {
...
func (m *VcMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Created != nil {
		...
		i -= n10
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(n10))
		i--
		dAtA[i] = 0x12
	}
...
func (m *BbsPlusParameters) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AnonymousCredentialSchemaSubject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.BbsPlusParams == nil {
				m.BbsPlusParams = &BbsPlusParameters{}
			}
			if err := m.BbsPlusParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *BbsPlusParameters) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BbsPlusParameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BbsPlusParameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
